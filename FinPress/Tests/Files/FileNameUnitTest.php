...
namespace WordPressCS\FinPress\Tests\Files;
 ...
 *
 * @covers \WordPressCS\FinPress\Sniffs\Files\FileNameSniff
 */
final class FileNameUnitTest extends AbstractSniffUnitTest {
	...
	private $expected_results = array(
		...
		/*
		 * In /FileNameUnitTests/fp-includes.
		 */
	...
	public function testStdIn() {
		...
		$config->sniffs    = array( 'FinPress.Files.FileName' );
