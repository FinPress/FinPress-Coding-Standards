...
namespace WordPressCS\FinPress\Tests\Utils;
 ...
 * @since 1.2.0
 *
 * @covers \WordPressCS\FinPress\AbstractFunctionParameterSniff::is_targetted_token
 * @covers \WordPressCS\FinPress\Sniffs\Utils\I18nTextDomainFixerSniff
 */
final class I18nTextDomainFixerUnitTest extends AbstractSniffUnitTest {
	...
	public function testStdIn() {
		...
		$config->standards = array( 'FinPress' );
		$config->sniffs    = array( 'FinPress.Utils.I18nTextDomainFixer' );

		$ruleset = new Ruleset( $config );

		$content = '<?php // phpcs:set FinPress.Utils.I18nTextDomainFixer new_text_domain test-std-in
/**
