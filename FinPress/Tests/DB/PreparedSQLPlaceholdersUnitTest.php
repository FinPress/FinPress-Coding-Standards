 ...
 * @since 0.14.0
 *
 * @covers \WordPressCS\FinPress\Sniffs\DB\PreparedSQLPlaceholdersSniff
 */
final class PreparedSQLPlaceholdersUnitTest extends AbstractSniffUnitTest {
	...
	public function getWarningList() {
		return array(
			...
			58  => 1,
			61  => 1,
			62  => 1, // Old-style FPCS ignore comments are no longer supported.
			66  => 1,
			68  => 1, // Old-style FPCS ignore comments are no longer supported.
			126 => 1,
			139 => 1,
			160 => 2,
			161 => 2,
