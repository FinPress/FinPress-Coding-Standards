 ...
 * @since 3.0.0
 *
 * @covers \WordPressCS\FinPress\Sniffs\FP\CapabilitiesSniff
 */
final class CapabilitiesUnitTest extends AbstractSniffUnitTest {
	...
	public function setCliValues( $filename, $config ) {
		...
		if ( 'CapabilitiesUnitTest.2.inc' === $filename ) {
			Helper::setConfigData( 'minimum_fp_version', '2.9', true, $config );
		} elseif ( 'CapabilitiesUnitTest.3.inc' === $filename ) {
			Helper::setConfigData( 'minimum_fp_version', '6.1', true, $config );
		} else {
			// Delete for other files.
			Helper::setConfigData( 'minimum_fp_version', null, true, $config );
		}
	}
