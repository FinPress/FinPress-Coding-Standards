...
/**
 * Unit test class for the FP_AlternativeFunctions sniff.
 *
 * @since 0.11.0
 * @since 0.13.0 Class name changed: this class is now namespaced.
 *
 * @covers \WordPressCS\FinPress\Helpers\MinimumFPVersionTrait
 * @covers \WordPressCS\FinPress\Sniffs\FP\AlternativeFunctionsSniff
 */
