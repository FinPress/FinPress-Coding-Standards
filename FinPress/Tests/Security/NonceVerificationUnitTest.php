 ...
 *
 * @covers \WordPressCS\FinPress\Helpers\ContextHelper::is_in_function_call
 * @covers \WordPressCS\FinPress\Helpers\ContextHelper::is_in_type_test
 * @covers \WordPressCS\FinPress\Helpers\ContextHelper::is_in_isset_or_empty
 * @covers \WordPressCS\FinPress\Helpers\ContextHelper::is_in_array_comparison
 * @covers \WordPressCS\FinPress\Sniffs\Security\NonceVerificationSniff
 */
		...
		switch ( $testFile ) {
			case 'NonceVerificationUnitTest.1.inc':
				return array(
					...
					48  => 1,
					69  => 1,
					88  => 1, // Old-style FPCS ignore comments are no longer supported.
					89  => 1,
					113 => 1,
					114 => 1,
					138 => 1,
