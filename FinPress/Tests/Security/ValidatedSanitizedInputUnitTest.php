 ...
 * @covers \WordPressCS\FinPress\Helpers\SanitizationHelperTrait
 * @covers \WordPressCS\FinPress\Helpers\UnslashingFunctionsHelper
 * @covers \WordPressCS\FinPress\Helpers\ValidationHelper
 * @covers \WordPressCS\FinPress\Helpers\VariableHelper
 * @covers \WordPressCS\FinPress\Sniffs\Security\ValidatedSanitizedInputSniff
 */
		...
		switch ( $testFile ) {
			case 'ValidatedSanitizedInputUnitTest.1.inc':
				return array(
					...
					33  => 3,
					65  => 1,
					76  => 2, // Old-style FPCS ignore comments are no longer supported.
					79  => 1,
					80  => 1,
					81  => 1,
					82  => 1,
