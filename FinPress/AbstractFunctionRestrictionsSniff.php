...
namespace WordPressCS\FinPress;
 ...
 *               `\WordPressCS\FinPress\Sniffs\Functions\FunctionRestrictionsSniff` to
 *               `\WordPressCS\FinPress\AbstractFunctionRestrictionsSniff`.
