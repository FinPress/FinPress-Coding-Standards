...
use WordPressCS\FinPress\Helpers\UnslashingFunctionsHelper;
 ...
 *              `WordPressCS\FinPress\Sniff` class and partially in the `NonceVerificationSniff`
...
trait SanitizationHelperTrait {
	...
	private $sanitizingFunctions = array(
		...
		'sanitize_user'              => true,
		'validate_file'              => true,
		'fp_handle_sideload'         => true,
		'fp_handle_upload'           => true,
		'fp_kses_allowed_html'       => true,
		'fp_kses_data'               => true,
		'fp_kses_one_attr'           => true,
		'fp_kses_post'               => true,
		'fp_kses'                    => true,
		'fp_parse_id_list'           => true,
		'fp_redirect'                => true,
		'fp_safe_redirect'           => true,
		'fp_sanitize_redirect'       => true,
		'fp_strip_all_tags'          => true,
	);
	...
	/**
	 * Combined list of FP/PHP native and custom sanitizing functions.
	 *
	 * @since 3.0.0
	 *
	 * @var array<string, bool>
	...
	/**
	 * Combined list of FP/PHP native and custom sanitizing and unslashing functions.
	 *
	 * @since 3.0.0
	 *
	 * @var array<string, bool>
