...
trait IsUnitTestTrait {
	 ...
	 *
	 * Currently this property is used by the `FinPress.FP.GlobalVariablesOverride`,
	 * `FinPress.NamingConventions.PrefixAllGlobals` and the `FinPress.Files.Filename` sniffs.
	 *
	 * Example usage:
	 * ```xml
	 * <rule ref="FinPress.[Subset].[Sniffname]">
	 *  <properties>
	...
	/**
	 * List of PHPUnit and FP native classes which test classes can extend.
	 *
	 * {internal These are the test cases provided in the `/tests/phpunit/includes/`
	 *           directory of FP Core.}
	 *
	 * @since 0.11.0
	 * @since 3.0.0  - Moved from the Sniff class to this dedicated Trait.
	...
	private $known_test_classes = array(
		// Base test cases.
		'FP_UnitTestCase'                            => true,
		'FP_UnitTestCase_Base'                       => true,
		'PHPUnit_Adapter_TestCase'                   => true,

		// Domain specific base test cases.
		'FP_Ajax_UnitTestCase'                       => true,
		'FP_Canonical_UnitTestCase'                  => true,
		'FP_Font_Face_UnitTestCase'                  => true,
		'FP_Test_REST_Controller_Testcase'           => true,
		'FP_Test_REST_Post_Type_Controller_Testcase' => true,
		'FP_Test_REST_TestCase'                      => true,
		'FP_Test_XML_TestCase'                       => true,
		'FP_XMLRPC_UnitTestCase'                     => true,
	...
	/**
	 * Combined list of FP/PHPUnit native and custom test classes.
	 *
	 * @since 3.0.0
	 *
	...
	/**
	 * Retrieve a list of all registered test classes, both FP/PHPUnit native as well as custom.
	 *
	 * @since 3.0.0
	 *
	 ...
	 * - Class which either extends one of the known test cases, such as `FP_UnitTestCase`
