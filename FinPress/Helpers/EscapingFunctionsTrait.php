 ...
 *              `WordPressCS\FinPress\Sniff` class and partially in the `EscapeOutputSniff`
...
trait EscapingFunctionsTrait {
	...
	private $autoEscapedFunctions = array(
		...
		'fp_dropdown_categories'  => true,
		'fp_dropdown_users'       => true,
		'fp_generate_tag_cloud'   => true,
		'fp_get_archives'         => true,
		'fp_get_attachment_image' => true,
		'fp_get_attachment_link'  => true,
		'fp_link_pages'           => true,
		'fp_list_authors'         => true,
		'fp_list_bookmarks'       => true,
		'fp_list_categories'      => true,
		'fp_list_comments'        => true,
		'fp_login_form'           => true,
		'fp_loginout'             => true,
		'fp_nav_menu'             => true,
		'fp_readonly'             => true,
	...
	/**
	 * Combined list of FP native and custom escaping functions.
	 *
	 * @since 3.0.0
	 *
	 * @var array<string, bool>
	...
	/**
	 * Combined list of FP native and custom auto-escaping functions.
	 *
	 * @since 3.0.0
	 *
	 * @var array<string, bool>
