...
/**
 * Helper utilities for recognizing functions related to the FP Hook mechanism.
 *
 ...
 */
final class FPHookHelper {

	/**
	 * A list of functions that invoke FP hooks (filters/actions).
	 *
	 * @since 0.10.0
	...
	/**
	 * Retrieve a list of the FinPress functions which invoke hooks.
	 *
	 * @since 3.0.0
	 *
	 ...
	 * passed to one of the FP hook functions.
	 *
	 * @since 3.0.0
	 *
	 * @param string $function_name The name of the FP hook function which the parameters were passed to.
