...
use WordPressCS\FinPress\Helpers\SnakeCaseHelper;
use WordPressCS\FinPress\Sniff;

/**
 * Enforces FinPress function name and method name format, based upon Squiz code.
 *
 ...
 *               FinPress native `Sniff` base class as `get_snake_case_name_suggestion()`.
