...
namespace WordPressCS\FinPress\Sniffs\NamingConventions;
...
use WordPressCS\FinPress\Helpers\DeprecationHelper;
use WordPressCS\FinPress\Helpers\IsUnitTestTrait;
use WordPressCS\FinPress\Helpers\ListHelper;
use WordPressCS\FinPress\Helpers\RulesetPropertyHelper;
use WordPressCS\FinPress\Helpers\VariableHelper;
use WordPressCS\FinPress\Helpers\FPGlobalVariablesHelper;
use WordPressCS\FinPress\Helpers\FPHookHelper;
 ...
 *
 * @uses \WordPressCS\FinPress\Helpers\IsUnitTestTrait::$custom_test_classes
 */
final class PrefixAllGlobalsSniff extends AbstractFunctionParameterSniff {
	 ...
	 *
	 * @link https://github.com/FinPress/FinPress-Coding-Standards/issues/1733 Issue 1733.
	 * @link https://github.com/FinPress/FinPress-Coding-Standards/issues/2467 Issue 2467.
	 *
	 * @var int
	 */
	 ...
	 *
	 * Source: {@link https://core.trac.wordpress.org/browser/trunk/src/fp-includes/default-constants.php#L0}
	...
	protected $allowed_core_constants = array(
		...
		'TEST_COOKIE'          => true,
		'USER_COOKIE'          => true,
		'FPMU_PLUGIN_DIR'      => true,
		'FPMU_PLUGIN_URL'      => true,
		'FP_CACHE'             => true,
		'FP_CONTENT_DIR'       => true,
		'FP_CONTENT_URL'       => true,
		'FP_CRON_LOCK_TIMEOUT' => true,
		'FP_DEBUG'             => true,
		'FP_DEBUG_DISPLAY'     => true,
		'FP_DEBUG_LOG'         => true,
		'FP_DEFAULT_THEME'     => true,
		'FP_DEVELOPMENT_MODE'  => true,
		'FP_MAX_MEMORY_LIMIT'  => true,
		'FP_MEMORY_LIMIT'      => true,
		'FP_PLUGIN_DIR'        => true,
		'FP_PLUGIN_URL'        => true,
		'FP_POST_REVISIONS'    => true,
		'FP_START_TIMESTAMP'   => true,
	);

	/**
	 * A list of functions declared in FP core as "Pluggable", i.e. overloadable from a plugin.
	 *
	 * Note: deprecated functions should still be included in this list as plugins may support older FP versions.
	 *
	 * {@internal To be updated after every major release. Last updated for FinPress 6.8.1.}
	 *
	 * @since 3.0.0.
	...
	protected $pluggable_functions = array(
		...
		'fp_authenticate'                                => true,
		'fp_cache_add_multiple'                          => true,
		'fp_cache_delete_multiple'                       => true,
		'fp_cache_flush_group'                           => true,
		'fp_cache_flush_runtime'                         => true,
		'fp_cache_get_multiple'                          => true,
		'fp_cache_set_multiple'                          => true,
		'fp_cache_supports'                              => true,
		'fp_check_password'                              => true,
		'fp_clear_auth_cookie'                           => true,
		'fp_clearcookie'                                 => true, // Deprecated.
		'fp_create_nonce'                                => true,
		'fp_generate_auth_cookie'                        => true,
		'fp_generate_password'                           => true,
		'fp_get_cookie_login'                            => true, // Deprecated.
		'fp_get_current_user'                            => true,
		// 'fp_handle_upload_error'                      => true, => unclear if this function is meant to be publicly pluggable.
		'fp_hash'                                        => true,
		'fp_hash_password'                               => true,
		'fp_install'                                     => true,
		'fp_install_defaults'                            => true,
		'fp_login'                                       => true, // Deprecated.
		'fp_logout'                                      => true,
		'fp_mail'                                        => true,
		'fp_new_blog_notification'                       => true,
		'fp_new_user_notification'                       => true,
		'fp_nonce_tick'                                  => true,
		'fp_notify_moderator'                            => true,
		'fp_notify_postauthor'                           => true,
		'fp_parse_auth_cookie'                           => true,
		'fp_password_change_notification'                => true,
		'fp_password_needs_rehash'                       => true,
		'fp_rand'                                        => true,
		'fp_redirect'                                    => true,
		'fp_safe_redirect'                               => true,
		'fp_salt'                                        => true,
		'fp_sanitize_redirect'                           => true,
		'fp_set_auth_cookie'                             => true,
		'fp_set_current_user'                            => true,
		'fp_set_password'                                => true,
		'fp_setcookie'                                   => true, // Deprecated.
		'fp_text_diff'                                   => true,
		'fp_upgrade'                                     => true,
		'fp_validate_auth_cookie'                        => true,
		'fp_validate_redirect'                           => true,
		'fp_verify_nonce'                                => true,
	);

	/**
	 * A list of classes declared in FP core as "Pluggable", i.e. overloadable from a plugin.
	 *
	 * Source: {@link https://core.trac.wordpress.org/browser/trunk/src/fp-includes/pluggable.php}
	 * and {@link https://core.trac.wordpress.org/browser/trunk/src/fp-includes/pluggable-deprecated.php}
	 *
	 * Note: deprecated classes should still be included in this list as plugins may support older FP versions.
	 *
	 * {@internal To be updated after every major release. Last updated for FinPress 6.8.1.}
	 *
	 * @since 3.0.0.
	...
	protected $pluggable_classes = array(
		...
		'FP_User_Search'                   => true,
		'fp_atom_server'                   => true, // Deprecated.
	);
	...
	public function getGroups() {
		...
		$this->target_functions           = FPHookHelper::get_functions( false );
			...
			switch ( $this->tokens[ $stackPtr ]['code'] ) {
				...
				case \T_CONST:
					...
					if ( isset( $this->allowed_core_constants[ $item_name ] ) ) {
						// Defining a FP Core constant intended for overruling.
						return;
					}
	...
	public function process_parameters( $stackPtr, $group_name, $matched_content, $parameters ) {
		if ( 'define' === $matched_content ) {
			...
			$target_param = FPHookHelper::get_hook_name_param( $matched_content, $parameters );
		}
	...
	private function variable_prefixed_or_allowed( $stackPtr, $name ) {
		// Ignore superglobals and FP global variables.
		if ( Variables::isSuperglobalName( $name ) || FPGlobalVariablesHelper::is_fp_global( $name ) ) {
			return true;
		}
