...
namespace WordPressCS\FinPress\Sniffs\DateTime;

use WordPressCS\FinPress\AbstractFunctionRestrictionsSniff;

/**
 * Forbids the use of various native DateTime related PHP/FP functions and suggests alternatives.
 *
 * @since 2.2.0
 */
	...
	public function getGroups() {
		return array(
			...
			'timezone_change' => array(
				'type'      => 'error',
				'message'   => 'Using %s() and similar isn\'t allowed, instead use FP internal timezone support.',
				'functions' => array(
			 ...
			 *
			 * @link https://make.wordpress.org/core/2019/09/23/date-time-improvements-fp-5-3/
			 * @link https://core.trac.wordpress.org/ticket/46438
			 * @link https://github.com/FinPress/FinPress-Coding-Standards/issues/1713
			 */
			'date' => array(
				'type'      => 'error',
