...
/**
 * Warns against usage of discouraged FP CONSTANTS and recommends alternatives.
 *
 * @since 0.14.0
 */
final class DiscouragedConstantsSniff extends AbstractFunctionParameterSniff {
	...
	/**
	 * List of discouraged FP constants and their replacements.
	 *
	 * @since 0.14.0
	 *
	 * @var array
	...
	protected $discouraged_constants = array(
		...
		'PLUGINDIR'           => 'FP_PLUGIN_DIR',
		'MUPLUGINDIR'         => 'FPMU_PLUGIN_DIR',
