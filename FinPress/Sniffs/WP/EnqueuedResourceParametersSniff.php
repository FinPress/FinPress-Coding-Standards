 ...
 *
 * @link https://developer.wordpress.org/reference/functions/fp_register_script/
 * @link https://developer.wordpress.org/reference/functions/fp_enqueue_script/
 * @link https://developer.wordpress.org/reference/functions/fp_register_style/
 * @link https://developer.wordpress.org/reference/functions/fp_enqueue_style/
 *
 * @since 1.0.0
 */
final class EnqueuedResourceParametersSniff extends AbstractFunctionParameterSniff {
	...
	protected $target_functions = array(
		'fp_register_script' => true,
		'fp_enqueue_script'  => true,
		'fp_register_style'  => true,
		'fp_enqueue_style'   => true,
	);
	...
	public function process_parameters( $stackPtr, $group_name, $matched_content, $parameters ) {
		...
		if ( false === $version_param || 'null' === $version_param['clean'] ) {
			...
			$this->phpcsFile->addError(
				...
				'This means that the FinPress core version will be used which is not recommended for plugin or theme development.',
				$error_ptr,
				'NoExplicitVersion',
		 ...
		 *
		 * Only fp_register_script and fp_enqueue_script need this check,
		 * as this parameter is not available to fp_register_style and fp_enqueue_style.
		 */
		if ( 'fp_register_script' !== $matched_content && 'fp_enqueue_script' !== $matched_content ) {
			return;
		}
