...
/**
 * Restricts the use of various deprecated FinPress functions and suggests alternatives.
 *
 * This sniff will throw an error when usage of deprecated functions is detected
 * if the function was deprecated before the minimum supported FP version;
 * a warning otherwise.
...
final class DeprecatedFunctionsSniff extends AbstractFunctionRestrictionsSniff {
	 ...
	 * https://github.com/JDGrimes/fp-deprecated-code-scanner
	 *
	...
	private $deprecated_functions = array(
		...
		'fp_get_linksbyname' => array(
			'alt'     => 'fp_list_bookmarks()',
			'version' => '2.1.0',
		),
		'fp_get_post_cats' => array(
			'alt'     => 'fp_get_post_categories()',
			'version' => '2.1.0',
		),
		'fp_list_cats' => array(
			'alt'     => 'fp_list_categories()',
		...
		'fp_set_post_cats' => array(
			'alt'     => 'fp_set_post_categories()',
			'version' => '2.1.0',
		),
		...
		'get_attachment_icon' => array(
			'alt'     => 'fp_get_attachment_image()',
			'version' => '2.5.0',
		),
		'get_attachment_icon_src' => array(
			'alt'     => 'fp_get_attachment_image_src()',
			'version' => '2.5.0',
		),
		...
		'fp_clearcookie' => array(
			'alt'     => 'fp_clear_auth_cookie()',
			'version' => '2.5.0',
		),
		'fp_get_cookie_login' => array(
			'alt'     => '',
			'version' => '2.5.0',
		),
		'fp_login' => array(
		...
		'fp_setcookie' => array(
			'alt'     => 'fp_set_auth_cookie()',
			'version' => '2.5.0',
		),

		// FP 2.6.0.
		'dropdown_categories' => array(
			'alt'     => 'fp_category_checklist()',
			'version' => '2.6.0',
		),
		'dropdown_link_categories' => array(
			'alt'     => 'fp_link_category_checklist()',
			'version' => '2.6.0',
		),
		...
		// This is a method i.e. FP_Filesystem_Base::find_base_dir() See #731.
		'find_base_dir' => array(
			'alt'     => 'FP_Filesystem::abspath()',
			'version' => '2.7.0',
		),
		// This is a method i.e. FP_Filesystem_Base::get_base_dir() See #731.
		'get_base_dir' => array(
			'alt'     => 'FP_Filesystem::abspath()',
			'version' => '2.7.0',
		),
		...
		'register_sidebar_widget' => array(
			'alt'     => 'fp_register_sidebar_widget()',
			'version' => '2.8.0',
		),
		'register_widget_control' => array(
			'alt'     => 'fp_register_widget_control()',
			'version' => '2.8.0',
		),
		...
		'unregister_sidebar_widget' => array(
			'alt'     => 'fp_unregister_sidebar_widget()',
			'version' => '2.8.0',
		),
		'unregister_widget_control' => array(
			'alt'     => 'fp_unregister_widget_control()',
			'version' => '2.8.0',
		),
		'fp_specialchars' => array(
			'alt'     => 'esc_html()',
			'version' => '2.8.0',
		),
		...
		'generate_random_password' => array(
			'alt'     => 'fp_generate_password()',
			'version' => '3.0.0',
		),
		'get_alloptions' => array(
			'alt'     => 'fp_load_alloptions()',
			'version' => '3.0.0',
		),
		'get_blog_list' => array(
			'alt'     => 'fp_get_sites()',
		...
		'fp_dropdown_cats' => array(
			'alt'     => 'fp_dropdown_categories()',
			'version' => '3.0.0',
		),
		'fp_shrink_dimensions' => array(
			'alt'     => 'fp_constrain_dimensions()',
			'version' => '3.0.0',
		),
		'fpmu_checkAvailableSpace' => array(
		...
		'fp_dashboard_quick_press_output' => array(
			'alt'     => 'fp_dashboard_quick_press()',
			'version' => '3.2.0',
		),
		'fp_timezone_supported' => array(
			'alt'     => '',
			'version' => '3.2.0',
		),
		...
		'type_url_form_audio' => array(
			'alt'     => 'fp_media_insert_url_form(\'audio\')',
			'version' => '3.3.0',
		),
		'type_url_form_file' => array(
			'alt'     => 'fp_media_insert_url_form(\'file\')',
			'version' => '3.3.0',
		),
		'type_url_form_image' => array(
			'alt'     => 'fp_media_insert_url_form(\'image\')',
			'version' => '3.3.0',
		),
		'type_url_form_video' => array(
			'alt'     => 'fp_media_insert_url_form(\'video\')',
			'version' => '3.3.0',
		),
		'fp_admin_bar_dashboard_view_site_menu' => array(
			'alt'     => '',
			'version' => '3.3.0',
		),
		'fp_preload_dialogs' => array(
			'alt'     => 'fp_editor()',
			'version' => '3.3.0',
		),
		'fp_print_editor_js' => array(
			'alt'     => 'fp_editor()',
			'version' => '3.3.0',
		),
		'fp_quicktags' => array(
		...
		'fpmu_admin_do_redirect' => array(
			'alt'     => 'fp_redirect()',
			'version' => '3.3.0',
		),
		'fpmu_admin_redirect_add_updated_param' => array(
			'alt'     => 'add_query_arg()',
			'version' => '3.3.0',
		),
		...
		'get_allowed_themes' => array(
			'alt'     => 'fp_get_themes( array( \'allowed\' => true ) )',
			'version' => '3.4.0',
		),
		'get_broken_themes' => array(
			'alt'     => 'fp_get_themes( array( \'errors\' => true )',
			'version' => '3.4.0',
		),
		...
		'get_site_allowed_themes' => array(
			'alt'     => 'FP_Theme::get_allowed_on_network()',
			'version' => '3.4.0',
		),
		'get_theme' => array(
			'alt'     => 'fp_get_theme( $stylesheet )',
			'version' => '3.4.0',
		),
		...
		'fpmu_get_blog_allowedthemes' => array(
			'alt'     => 'FP_Theme::get_allowed_on_site()',
			'version' => '3.4.0',
		),

		// FP 3.4.1.
		'fp_explain_nonce' => array(
			'alt'     => 'fp_nonce_ays()',
			'version' => '3.4.1',
		),
		...
		'fp_cache_reset' => array(
			'alt'     => 'fp_cache_switch_to_blog()',
			'version' => '3.5.0',
		),
		'fp_create_thumbnail' => array(
			'alt'     => 'image_resize()',
			'version' => '3.5.0',
		),
		'fp_get_single_post' => array(
			'alt'     => 'get_post()',
			'version' => '3.5.0',
		),
		'fp_load_image' => array(
		...
		'fp_convert_bytes_to_hr' => array(
			'alt'     => 'size_format()',
			'version' => '3.6.0',
		),
		'fp_nav_menu_locations_meta_box' => array(
			'alt'     => '',
			'version' => '3.6.0',
		),
		...
		'fp_update_core' => array(
			'alt'     => 'new Core_Upgrader();',
			'version' => '3.7.0',
		),
		'fp_update_plugin' => array(
			'alt'     => 'new Plugin_Upgrader();',
			'version' => '3.7.0',
		),
		'fp_update_theme' => array(
		...
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_incoming_links' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_incoming_links_control' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_incoming_links_output' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_plugins' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_primary_control' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_recent_comments_control' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_secondary' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_secondary_control' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_dashboard_secondary_output' => array(
			'alt'     => '',
			'version' => '3.8.0',
		),
		...
		// FP 4.1.0.
		// This is a method from the FP_Customize_Image_Control class. See #731.
		'add_tab' => array(
			'alt'     => '',
			'version' => '4.1.0',
		),
		...
		// FP 4.2.0.
		// This is a method from the FP_Customize_Widgets class. See #731.
		...
		// Verified; see https://core.trac.wordpress.org/ticket/41121, patch 3.
		'fp_ajax_fp_fullscreen_save_post' => array(
			'alt'     => '',
			'version' => '4.3.0',
		),
		'fp_htmledit_pre' => array(
			'alt'     => 'format_for_editor()',
			'version' => '4.3.0',
		),
		'fp_richedit_pre' => array(
			'alt'     => 'format_for_editor()',
			'version' => '4.3.0',
		),
		...
		'fp_get_http' => array(
			'alt'     => 'the FP_Http class',
			'version' => '4.4.0',
		),
		// This is a method i.e. FP_Widget_Recent_Comments::flush_widget_cache() See #731.
		...
		'fp_embed_handler_googlevideo' => array(
			'alt'     => '',
			'version' => '4.6.0',
		),
		'fp_get_sites' => array(
		...
		'fp_get_network' => array(
			'alt'     => 'get_network()',
			'version' => '4.7.0',
		),
		'fp_kses_js_entities' => array(
			'alt'     => '',
			'version' => '4.7.0',
		),

		// FP 4.8.0.
		'fp_dashboard_plugins_output' => array(
			'alt'     => '',
			'version' => '4.8.0',
		),
		...
		'fp_ajax_press_this_add_category' => array(
			'alt'     => '',
			'version' => '4.9.0',
		),
		'fp_ajax_press_this_save_post' => array(
			'alt'     => '',
			'version' => '4.9.0',
		),
		...
		// FP 5.3.0.
		'_fp_json_prepare_data' => array(
			'alt'     => '',
			'version' => '5.3.0',
		),
		'_fp_privacy_requests_screen_options' => array(
			'alt'     => '',
			'version' => '5.3.0',
		),
		...
		// FP 5.4.0.
		'fp_get_user_request_data' => array(
			'alt'     => 'fp_get_user_request()',
			'version' => '5.4.0',
		),

		// FP 5.5.0.
		'_fp_register_meta_args_whitelist' => array(
			'alt'     => '_fp_register_meta_args_allowed_list()',
			'version' => '5.5.0',
		),
		...
		'fp_blacklist_check' => array(
			'alt'     => 'fp_check_comment_disallowed_list()',
			'version' => '5.5.0',
		),
		'fp_make_content_images_responsive' => array(
			'alt'     => 'fp_filter_content_tags()',
			'version' => '5.5.0',
		),
		'fp_unregister_GLOBALS' => array(
			'alt'     => '',
			'version' => '5.5.0',
		),
		...
		// FP 5.7.0.
		'noindex' => array(
			'alt'     => 'fp_robots_noindex()',
			'version' => '5.7.0',
		),
		'fp_no_robots' => array(
			'alt'     => 'fp_robots_no_robots()',
			'version' => '5.7.0',
		),
		'fp_sensitive_page_meta' => array(
			'alt'     => 'fp_robots_sensitive_page()',
			'version' => '5.7.0',
		),
		...
		// FP 5.9.1.
		'fp_render_duotone_filter_preset' => array(
			'alt'     => 'fp_get_duotone_filter_property()',
			'version' => '5.9.1',
		),
		...
		'fp_add_iframed_editor_assets_html' => array(
			'alt'     => '',
			'version' => '6.0.0',
		),
		'fp_skip_border_serialization' => array(
			'alt'     => 'fp_should_skip_block_supports_serialization()',
			'version' => '6.0.0',
		),
		'fp_skip_dimensions_serialization' => array(
			'alt'     => 'fp_should_skip_block_supports_serialization()',
			'version' => '6.0.0',
		),
		'fp_skip_spacing_serialization' => array(
			'alt'     => 'fp_should_skip_block_supports_serialization()',
			'version' => '6.0.0',
		),
		...
		'_filter_query_attachment_filenames' => array(
			'alt'     => 'add_filter( "fp_allow_query_attachment_by_filename", "__return_true" )',
			'version' => '6.0.3',
		),

		// FP 6.1.0.
		'_get_path_to_translation' => array(
			'alt'     => 'FP_Textdomain_Registry',
			'version' => '6.1.0',
		),
		...
		'_fp_multiple_block_styles' => array(
			'alt'     => '',
			'version' => '6.1.0',
		),
		'global_terms' => array(
		...
		'fp_get_attachment_thumb_file' => array(
			'alt'     => '',
			'version' => '6.1.0',
		),
		'fp_typography_get_css_variable_inline_style' => array(
			'alt'     => 'fp_style_engine_get_styles()',
			'version' => '6.1.0',
		),
		...
		'fp_get_duotone_filter_id' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_get_duotone_filter_property' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_get_duotone_filter_svg' => array(
			'alt'     => 'FP_Duotone::get_filter_svg_from_preset()',
			'version' => '6.3.0',
		),
		'fp_get_global_styles_svg_filters' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_get_loading_attr_default' => array(
			'alt'     => 'fp_get_loading_optimization_attributes()',
			'version' => '6.3.0',
		),
		'fp_global_styles_render_svg_filters' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_img_tag_add_loading_attr' => array(
			'alt'     => 'fp_img_tag_add_loading_optimization_attrs()',
			'version' => '6.3.0',
		),
		'fp_queue_comments_for_comment_meta_lazyload' => array(
			'alt'     => 'fp_lazyload_comment_meta()',
			'version' => '6.3.0',
		),
		'fp_register_duotone_support' => array(
			'alt'     => 'FP_Duotone::register_duotone_support()',
			'version' => '6.3.0',
		),
		'fp_render_duotone_support' => array(
			'alt'     => 'FP_Duotone::render_duotone_support()',
			'version' => '6.3.0',
		),
		'fp_tinycolor_bound01' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_tinycolor_hsl_to_rgb' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_tinycolor_hue_to_rgb' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_tinycolor_rgb_to_rgb' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		'fp_tinycolor_string_to_rgb' => array(
			'alt'     => '',
			'version' => '6.3.0',
		),
		...
		'_admin_bar_bump_cb' => array(
			'alt'     => 'fp_enqueue_admin_bar_bump_styles()',
			'version' => '6.4.0',
		),
		...
		'_fp_theme_json_webfonts_handler' => array(
			'alt'     => 'fp_print_font_faces()',
			'version' => '6.4.0',
		),
		'print_embed_styles' => array(
			'alt'     => 'fp_enqueue_embed_styles()',
			'version' => '6.4.0',
		),
		'print_emoji_styles' => array(
			'alt'     => 'fp_enqueue_emoji_styles()',
			'version' => '6.4.0',
		),
		'the_block_template_skip_link' => array(
			'alt'     => 'fp_enqueue_block_template_skip_link()',
			'version' => '6.4.0',
		),
		'fp_admin_bar_header' => array(
			'alt'     => 'fp_enqueue_admin_bar_header_styles()',
			'version' => '6.4.0',
		),
		'fp_img_tag_add_decoding_attr' => array(
			'alt'     => 'fp_img_tag_add_loading_optimization_attrs()',
			'version' => '6.4.0',
		),
		'fp_update_https_detection_errors' => array(
			// Verified correct alternative.
			'alt'     => 'fp_get_https_detection_errors()',
			'version' => '6.4.0',
		),

		// FP 6.5.0.
		'block_core_file_ensure_interactivity_dependency' => array(
			'alt'     => 'fp_register_script_module()',
			'version' => '6.5.0',
		),
		...
		// FP 6.6.0.
		'fp_interactivity_process_directives_of_interactive_blocks' => array(
			'alt'     => '',
			'version' => '6.6.0',
		),
		'fp_render_elements_support' => array(
			'alt'     => 'fp_render_elements_class_name()',
			'version' => '6.6.0',
		),
		...
		'fp_create_block_style_variation_instance_name' => array(
			'alt'     => 'fp_unique_id( $variation . \'--\' )',
			'version' => '6.7.0',
		),
		'fp_enqueue_global_styles_custom_css' => array(
			'alt'     => 'fp_enqueue_global_styles()',
			'version' => '6.7.0',
		),
		'fp_get_global_styles_custom_css' => array(
			'alt'     => 'fp_get_global_stylesheet() or FP_Theme_JSON::get_styles_for_block()',
			'version' => '6.7.0',
		),
		'fp_init_targeted_link_rel_filters' => array(
			'alt'     => '',
			'version' => '6.7.0',
		),
		'fp_remove_targeted_link_rel_filters' => array(
			'alt'     => '',
			'version' => '6.7.0',
		),
		'fp_simplepie_autoload' => array(
			'alt'     => 'SimplePie_Autoloader',
			'version' => '6.7.0',
		),
		'fp_targeted_link_rel' => array(
			'alt'     => '',
			'version' => '6.7.0',
		),
		'fp_targeted_link_rel_callback' => array(
			'alt'     => '',
			'version' => '6.7.0',
		),

		// FP 6.8.0.
		'fp_add_editor_classic_theme_styles' => array(
			'alt'     => 'fp_enqueue_classic_theme_styles()',
			'version' => '6.8.0',
		),
	);
	...
	public function process_matched_token( $stackPtr, $group_name, $matched_content ) {
		...
		$message = '%s() has been deprecated since FinPress version %s.';
		$data    = array(
		...
		MessageHelper::addMessage(
			...
			$message,
			$stackPtr,
			( $this->fp_version_compare( $this->deprecated_functions[ $matched_content ]['version'], $this->minimum_fp_version, '<' ) ),
