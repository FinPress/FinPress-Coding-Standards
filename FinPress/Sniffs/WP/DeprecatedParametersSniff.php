...
/**
 * Check for usage of deprecated parameters in FP functions and suggest alternative based on the parameter passed.
 *
 ...
 * FP version; a warning otherwise.
...
final class DeprecatedParametersSniff extends AbstractFunctionParameterSniff {
	 ...
	 * @var string
	 */
	protected $group_name = 'fp_deprecated_parameters';
	...
	protected $target_functions = array(
		...
		'_fp_post_revision_fields' => array(
			2 => array(
				'name'    => 'deprecated',
				'value'   => false,
				'version' => '4.5.0',
		...
		'fp_new_user_notification' => array(
			2 => array(
				'name'    => 'deprecated',
				'value'   => null,
				'version' => '4.3.1',
		...
		'fp_render_elements_support_styles' => array(
			1 => array(
				'name'    => 'parsed_block',
				'value'   => null,
				'version' => '6.6.0',
	...
	public function process_parameters( $stackPtr, $group_name, $matched_content, $parameters ) {
		...
		foreach ( $this->target_functions[ $matched_content ] as $position => $parameter_args ) {
			...
			$message  = 'The parameter "%s" at position #%s of %s() has been deprecated since FinPress version %s.';
			$is_error = $this->fp_version_compare( $parameter_args['version'], $this->minimum_fp_version, '<' );
