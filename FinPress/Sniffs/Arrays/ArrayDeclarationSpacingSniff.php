...
/**
 * Enforces FinPress array spacing format.
 *
 ...
 *
 * @since 0.11.0 - The FinPress specific additional checks have now been split off
 *                 from the `FinPress.Arrays.ArrayDeclaration` sniff into this sniff.
 ...
 * @since 0.13.0 Added the last remaining checks from the `FinPress.Arrays.ArrayDeclaration`
 *               sniff which were not covered elsewhere.
 *               The `FinPress.Arrays.ArrayDeclaration` sniff has now been deprecated.
