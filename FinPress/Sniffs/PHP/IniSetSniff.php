...
final class IniSetSniff extends AbstractFunctionParameterSniff {
	 ...
	 * the value of these, won't cause interoperability issues between FP/plugins/themes.
	 *
	 * @since 2.1.0
	 ...
	 * the value of these, will be problematic for interoperability between FP/plugins/themes.
	 *
	 * @since 2.1.0
	...
	protected $disallowed_options = array(
		...
		'display_errors' => array(
			'message' => 'Use `FP_DEBUG_DISPLAY` instead.',
		),
		'error_reporting' => array(
			'message' => 'Use `FP_DEBUG` instead.',
		),
		...
		'log_errors' => array(
			'message' => 'Use `FP_DEBUG_LOG` instead.',
		),
		'max_execution_time' => array(
			'message' => 'Use `set_time_limit()` instead.',
		),
		'memory_limit' => array(
			'message' => 'Use `fp_raise_memory_limit()` or hook into the filters in that function.',
		),
		'short_open_tag' => array(
